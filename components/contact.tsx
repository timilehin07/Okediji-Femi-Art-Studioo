...
export default function Contact() {
  ...
  return (
    <section className="py-20 px-6 md:py-32 bg-card" id="contact">
      <div className="max-w-3xl mx-auto">
        <div className="mb-12 text-center">
          <h2 className="text-5xl md:text-6xl font-bold mb-4 animate-fade-in">Contact</h2>
          <h3 className="text-3xl md:text-4xl font-semibold mb-6 text-accent">Get in Touch</h3>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interested in commissioning a work or discussing collaboration? I'd love to hear from you.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
          <div className="animate-slide-up" style={{ animationDelay: "0.1s" }}>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all duration-300 hover:border-accent"
          ...
          <div className="animate-slide-up" style={{ animationDelay: "0.3s" }}>
            ...
            <textarea
              ...
              required
              rows={6}
              className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary resize-none transition-all duration-300 hover:border-accent"
          ...
          <button
            type="submit"
            className="w-full px-8 py-3 bg-primary text-primary-foreground font-medium hover:opacity-90 transition-all duration-300 rounded-lg transform hover:scale-105 active:scale-95 animate-slide-up"
        ...
        <div className="mt-16 pt-12 border-t border-border">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="animate-fade-in" style={{ animationDelay: "0.7s" }}>
              <p className="text-sm text-muted-foreground mb-2">✉️ Email</p>
              <a
          ...
          <div className="mt-8 pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground mb-6">Follow</p>
