...
export default function About() {
  ...
  useEffect(() => {
    async function fetchImage() {
      const data: AboutData | null = await client.fetch(`
        *[_type == "about"][0]{
          artistImage
        }
      `)
            ...
            <div className="space-y-4">
              ...
              {expandedSection === "bio" && (
                <div className="p-6 bg-card border border-border rounded-lg space-y-4 text-base leading-relaxed text-muted-foreground">
                  <p>
                    Born on March 25th, 1995, Okediji Femi Samuel is a Nigerian artist (sculptor), hailing from Oyo State.
                  </p>
                  <p>
                    He began his journey in art with a National Diploma in General Art from The Polytechnic Ibadan,
                    and later earned his Higher National Diploma in Sculpture from Yaba College of Technology.
                  </p>
                  <p>
                    Over the years, Okediji Femi has developed a unique style blending traditional sculpting techniques
                    with contemporary themes, creating works that resonate widely.
                  </p>
                </div>
              )}
              ...
              {expandedSection === "statement" && (
                <div className="p-6 bg-card border border-border rounded-lg space-y-4 text-base leading-relaxed text-muted-foreground">
                  <p>
                    In my sculptures, I capture the dance of my surroundings, society's narratives, and the presence
                    of women in everyday life. The pieces are textured with lace and materials that reflect resilience
                    and tradition.
                  </p>
                  <p>
                    My works invite viewers to touch, reflect, and connect with the layered human experience, exploring
                    the beautiful imprints and patterns that shape our world.
                  </p>
                </div>
              )}
